...
vector<string> games = { ${toCppStringArray(games)} };
vector<string> allCoreNoVCacheGames = { ${toCppStringArray(staticConfig.allCoreNoVCacheGames)} };
vector<string> cacheGames = { ${toCppStringArray(staticConfig.cacheGames)} };
vector<string> services = { ${toCppStringArray(staticConfig.services)} };
`;
}
