...
string services[] = {"BsgLauncher.exe", "chrome.exe", "Discord.exe", "firefox.exe", "lghub.exe", "L-Connect 3.exe", "msedge.exe", "nextcloud.exe","obs64.exe", "SamsungMagician.exe", "ShareX.exe", "Spotify.exe", "steamwebhelper.exe", "ts3client_win64.exe", "wallpaper64.exe"};
